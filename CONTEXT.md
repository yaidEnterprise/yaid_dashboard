...
- As 4 tabelas centralizadas (`companies`, `company_apps`, `proof_requests`, `proof_sessions`) são todas sobre o lado empresarial e o processo de pedido de validação — nunca sobre o holder.
