...
import { z } from "zod";
import type { CompanyAppRepository } from "@/modules/company-app/domain/repositories/CompanyAppRepository";
import type { ApiKeyHasher } from "@/modules/company-app/domain/services/ApiKeyHasher";
import type { CompanyRepository } from "@/modules/company/domain/repositories/CompanyRepository";
import type { ProofRequestRepository } from "@/modules/proof-request/domain/repositories/ProofRequestRepository";
import type { ProofSessionRepository } from "@/modules/proof-request/domain/repositories/ProofSessionRepository";
...
export class Environments {
  ...
  async getCompanyRepository(): Promise<CompanyRepository> {
    ...
    const { SupabaseCompanyRepository } = await import(
      "@/modules/company/infra/repositories/SupabaseCompanyRepository"
    );
  ...
  async getCompanyAppRepository(): Promise<CompanyAppRepository> {
    ...
    const { SupabaseCompanyAppRepository } = await import(
      "@/modules/company-app/infra/repositories/SupabaseCompanyAppRepository"
    );
  ...
  async getProofRequestRepository(): Promise<ProofRequestRepository> {
    ...
    const { SupabaseProofRequestRepository } = await import(
      "@/modules/proof-request/infra/repositories/SupabaseProofRequestRepository"
    );
  ...
  async getProofSessionRepository(): Promise<ProofSessionRepository> {
    ...
    const { SupabaseProofSessionRepository } = await import(
      "@/modules/proof-request/infra/repositories/SupabaseProofSessionRepository"
    );
  ...
  async getApiKeyHasher(): Promise<ApiKeyHasher> {
    const { Sha256ApiKeyHasher } = await import(
      "@/modules/company-app/infra/services/Sha256ApiKeyHasher"
    );
...
export const env = Environments.getEnvs();
